...
namespace :photos do
  ...
  task build_gallery: :environment do
    ...
    photo = Photo.new(description: "20/10/16: OMHSN’s launch night")
    ...
    photo = Photo.new(description: "20/10/16: Attendees check out resources at OMHSN’s launch night")
    photo.remote_photo_url = url
    photo.save

    url = 'https://res.cloudinary.com/djdgvuktb/image/upload/v1515454318/26179424_10212897188358236_701701645_o_acqhek.jpg'
    photo = Photo.new(description: "OMHSN’s Time to Talk Day poster")
    photo.remote_photo_url = url
    photo.save

    url = 'https://res.cloudinary.com/djdgvuktb/image/upload/v1515454319/26238192_10212897188238233_1383975698_o_ilvthl.jpg'
    photo = Photo.new(description: "02/02/17: Co-Chair Kathryn Cole (right) discussing Oxford’s mental health volunteering opportunities at OMHSN’s Time to Talk Day event")
    photo.remote_photo_url = url
    photo.save

    url = 'https://res.cloudinary.com/djdgvuktb/image/upload/v1515454317/26179042_10212897188198232_1164543493_o_kl8rj7.jpg'
    photo = Photo.new(description: "02/02/17: Keynote speaker Adrian Garcia (Commander-in-chief of SANE’s Black Dog Campaign) at discussing his work at OMHSN’s Time to Talk Day event")
    photo.remote_photo_url = url
    photo.save
